...
@Override
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO personagens (char_nome, char_nivel, char_raca, char_class, char_back, char_str, char_dex,char_cons, char_int,char_wis,char_char,char_hp,char_desc) VALUES ('nome', 'raca', 'classe', 'background', 1, 2, 3, 4, 5, 6, 7,8, 'desc')");
}
